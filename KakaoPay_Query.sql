...
ALTER TABLE tt_sprinkling MODIFY COLUMN TOKEN VARCHAR(128);
COMMIT;
		...
		VALUES (
					'edcf89caa446ef71d616c4f7ffd2815b',
					'1000',
					'200',
					'0',
					(SELECT ROOM FROM TM_USER WHERE ID = '1'),
...
INSERT INTO tm_user VALUES('2', 'room1');
INSERT INTO tm_user VALUES('3', 'room2');
INSERT INTO tm_user VALUES('4', 'room1');

SELECT COUNT(*) AS CNT
		  FROM TT_SPRINKLING
		 WHERE TOKEN = '27d7ec63e82370622e9cafc4b3646e34'
		   AND ACTION_ID  = '1'
		   AND RECIEVE_ID IS NULL

UPDATE tt_sprinkling SET status_cd = '0', recieve_id=null WHERE SEQ=40;
SELECT COUNT(*) AS CNT
		  FROM TT_SPRINKLING
		 WHERE TOKEN = '27d7ec63e82370622e9cafc4b3646e34'
		   AND STATUS_CD = '0'
